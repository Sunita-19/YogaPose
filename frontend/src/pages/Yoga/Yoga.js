...
let poseList = ['Tree', 'Chair', 'Cobra', 'Warrior', 'Dog', 'Shoulderstand', 'Triangle', 'Utkatasana', 'Paschimottanasana', 'Setu Bandhasana', 'Marjaryasana Bitilasana'];
