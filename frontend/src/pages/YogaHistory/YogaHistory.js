...
import Yoga_Intro from '../../utils/images/Yoga_Intro.jpg';
import YogaIntro from '../../utils/images/YogaIntro.jpg';
import SageImg from '../../utils/images/SageImg.png';
const YogaHistory = () => {
  return (
...
<p></p>
      ...
      <img src={YogaIntro} alt="yoga" /> 
        ...
        <img src={Yoga_Intro} alt="Yoga and its significance" />
      </section>
...
<p></p>
<b>Yoga’s long rich history can be divided into four main periods of innovation, practice and development.</b>
<p></p>
<li>Pre Classical Yoga</li>
<li>Classical Yoga</li>
<li>Post Classical Yoga</li>
<li>Modern Period</li>
        </p>
        <img src={SageImg} alt="Ancient sages practicing yoga" />
      </section>

      <section className="pre-classical">
      ...
      <section className="post-classical">
